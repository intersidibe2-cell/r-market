...
INSERT INTO produits_russe (name, name_ru, description, description_ru, price, original_price, image, category, badge, rating, reviews, stock, sold)
SELECT name, name_ru, description, description_ru, price, original_price, image, category, badge, rating, reviews, stock, sold
FROM (VALUES
    -- Souvenirs & Artisanat
    (1001, 'Boubou traditionnel', 'Boubou traditionnel malien', 'Традиционный малийский бубу', 35000, 55000, 'https://images.unsplash.com/photo-1590735213920-68192a487bc2?w=500&h=500&fit=crop', 'souvenirs', 'Artisan', 4.9, 567, 80, 340),
    (1002, 'Pagne wax hollandais Vlisco', 'Pagne wax hollandais Vlisco authentic', 'Подлинный голландский восковой пagne Vlisco', 18000, 25000, 'https://images.unsplash.com/photo-1604328698692-f76ea9498e76?w=500&h=500&fit=crop', 'souvenirs', 'Best-seller', 4.7, 890, 150, 600),
    (1003, 'Statuette Dogon', 'Statuette Dogon en bois sculpté', 'Догонская статуэтка из резанного дерева', 45000, 60000, 'https://images.unsplash.com/photo-1582555172866-f73bb12a2ab3?w=500&h=500&fit=crop', 'souvenirs', 'Artisan', 4.9, 5, 8, 3),
    (1004, 'Bijoux Argent Massalia', 'Bracelet artisanal en argent, Mali', 'Артистический серебряный браслет, Мали', 65000, 85000, 'https://images.unsplash.com/photo-1515562141207-7a88fb7ce338?w=500&h=500&fit=crop', 'souvenirs', 'Artisan', 5.0, 7, 5, 2),
    (1005, 'Tenture Murale Bogolan', 'Tenture murale bogolan, 150x100cm', 'Боголанский гобелен, 150x100см', 42000, 55000, 'https://images.unsplash.com/photo-1586023492125-27b2c045efd7?w=500&h=500&fit=crop', 'souvenirs', 'Artisan', 4.8, 11, 12, 8),
    (1006, 'Mèches cheveux qualité premium', 'Mèches cheveux 100% humaines. Couleurs variées.', 'Волосы на наращивание 100% человеческие. Различные цвета.', 15000, 22000, 'https://images.unsplash.com/photo-1522337360788-8b13dee7a37e?w=500&h=500&fit=crop', 'souvenirs', 'Best-seller', 4.7, 1890, 100, 1450),
    
    -- Alcools & Boissons
    (2001, 'Whisky Importé', 'Whisky importé de qualité', 'Импортный виски высокого качества', 25000, 35000, 'https://images.unsplash.com/photo-1514731704710-2bac96bee12c?w=500&h=500&fit=crop', 'alcohol', 'Nouveau', 4.6, 234, 45, 180),
    (2002, 'Vin Rouge Français', 'Vin rouge français AOC', 'Французское красное вино AOC', 18000, 25000, 'https://images.unsplash.com/photo-1511015416381-5d68e1a92d7f?w=500&h=500&fit=crop', 'alcohol', 'Promo', 4.4, 567, 60, 320),
    (2003, 'Champagne Importé', 'Champagne brut importé', 'Импортное шампанское брют', 45000, 65000, 'https://images.unsplash.com/photo-1594736607984-0dd98c6c6b1d?w=500&h=500&fit=crop', 'alcohol', 'Exclusif', 4.8, 89, 15, 45),
    (2004, 'Rhum Agricole', 'Rhum agricole des Antilles', 'Агрокольский ром с Антильских островов', 22000, 30000, 'https://images.unsplash.com/photo-1600891996335-780g7rcbc6b1?w=500&h=500&fit=crop', 'alcohol', 'Populaire', 4.5, 432, 80, 290),
    (2005, 'Vodka Premium', 'Vodka triple distillée', 'Тройная дистилляция водки', 15000, 22000, 'https://images.unsplash.com/photo-1600891994492-4e9d74840deb?w=500&h=500&fit=crop', 'alcohol', 'Nouveau', 4.6, 678, 100, 420),
    (2006, 'Bière Importée', 'Bière pression importée', 'Импортное разливное пиво', 8000, 12000, 'https://images.unsplash.com/photo-1600891994931-30a4d637d5c3?w=500&h=500&fit=crop', 'alcohol', 'Local', 4.3, 2345, 200, 980),
    
    -- Produits Alimentaires
    (3001, 'Thé du Mali vert', 'Thé vert malien de qualité', 'Зеленый чай из Мали высокого качества', 3500, 5000, 'https://images.unsplash.com/photo-1556679343-c7306c1976bc?w=500&h=500&fit=crop', 'food', 'Local', 4.8, 2345, 500, 1800),
    (3002, 'Poivre noir de Tombouctou', 'Poivre noir authentique de Tombouctou', 'Подлинный черный перец из Тимбукту', 6000, 9000, 'https://images.unsplash.com/photo-1596040033229-a9821ebd058d?w=500&h=500&fit=crop', 'food', 'Premium', 4.9, 890, 300, 650),
    (3003, 'Beurre de karité bio pur 500ml', 'Beurre de karité 100% pur et bio du Mali.', '100% чистое и биологическое караите из Мали 500мл', 5000, 8000, 'https://images.unsplash.com/photo-1556228578-0d85b1a4d571?w=500&h=500&fit=crop', 'food', 'Bio', 4.8, 1678, 400, 1320),
    (3004, 'Gingembre frais bio', 'Gingembre frais local. Pour cuisine et santé.', 'Свежий местный имбирь. Для кухни и здоровья.', 2500, 4000, 'https://images.unsplash.com/photo-1615485290382-441e4d049cb5?w=500&h=500&fit=crop', 'food', 'Snack', 4.6, 1234, 600, 890),
    (3005, 'Miel naturel du Burkina', 'Miel pur 100% naturel. Propriétés médicinales.', '100% натуральный мед. Лечебные свойства.', 7500, 10000, 'https://images.unsplash.com/photo-1587049352846-4a222e784d38?w=500&h=500&fit=crop', 'food', 'Bio', 4.8, 890, 200, 560),
    (3006, 'Farine de mil local', 'Farine de mil pour bouillie et tg.', 'Мука из проса для каши и тг.', 2000, 3000, 'https://images.unsplash.com/photo-1574323347407-f5e1ad6d020b?w=500&h=500&fit=crop', 'food', 'Staple', 4.5, 2345, 800, 1500),
    
    -- Taux de change (produit spécial)
    (9001, 'Taux de change USD/CFA', 'Taux de change actuel USD vers CFA', 'Текущий обменный курс USD к CFA', 1, NULL, 'https://images.unsplash.com/photo-1611974419941-2ef24bafccbd?w=500&h=500&fit=crop', 'exchange', NULL, 4.5, 0, 0, 0)
) AS v(id, name, name_ru, description, description_ru, price, original_price, image, category, badge, rating, reviews, stock, sold)
